                                            ...
                                            <form action="/admin/event/create" method="post">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input name="bandNames" type="text" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input name="ticketPrice"  type="text" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select class="form-control custom-select-value"
                                                                        name="status">
                                                                    <option
                                                                        value="{{\App\Enums\EventStatus::POST_PONE}}">
                                                                        Post pone
                                                                    </option>
                                                                    <option
                                                                        value="{{\App\Enums\EventStatus::IS_HAPPENING}}">
                                                                        Is Happening
                                                                    </option>
                                                                    <option
                                                                        value="{{\App\Enums\EventStatus::UP_COMING}}">Up
                                                                        Coming
                                                                    </option>
                                                                    <option
                                                                        value="{{\App\Enums\EventStatus::TAKE_PLACE}}">
                                                                        Take Place
                                                                    </option>
                                                                </select>
                                                            </div>
